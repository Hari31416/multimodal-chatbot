...
class SessionAssembler:
    ...
    async def get_complete_session(
        ...
        try:
            ...
            # Step 4: Collect and batch-fetch all artifacts
            messages_with_artifacts = await self._attach_artifacts_to_messages(messages)
            ...
            return SessionResponse(
                ...
                updatedAt=session_metadata.updatedAt,
                title=session_metadata.title,
                messages=messages_with_artifacts,
                numMessages=len(messages_with_artifacts),
            )
